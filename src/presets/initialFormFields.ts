...
const initialFormFields: formFieldType[] = [
  ...
  { kind: "dropdown", id: 3, label: "Email", options: ["gmail", "hotmail"], value: "" },
  { kind: "text", id: 4, label: "Date of Birth", fieldType: "date", value: "" },
  { kind: "radio", id: 5, label: "Gender", options: ["Male(M)", "Female(F)", "Other(X)"], value: "" },
  { kind: "multiselect", id: 6, label: "Domain of work", options: ["Frontend Web Dev", "Backend Web Dev", "Full Stack Web Dev", "AI/ML", "Blockchain"], value: [] },
